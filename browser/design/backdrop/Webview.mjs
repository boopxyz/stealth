  ...
  if (url !== null) {
    ...
    if (mime !== null) {
      if (
        ...
        src =
          "/browser/internal/media.html?url=" + encodeURIComponent(url.link);
        ...
        src =
          "/browser/internal/fix-connection.html?url=" +
          encodeURIComponent(url.link);
      }
    } else {
      src =
        "/browser/internal/fix-connection.html?url=" +
...
const toURL = function (src) {
  ...
  if (src !== null) {
    if (src.startsWith("/browser/internal/fix-connection.html?url=") === true) {
      ...
      if (tmp !== null) {
        url = URL.parse(
          "stealth:fix-connection?url=" + decodeURIComponent(tmp)
        );
      }
    } else if (
      src.startsWith("/browser/internal/fix-host.html?url=") === true
    ) {
      let tmp = (src.split("?url=").pop() || "").split("&").shift() || null;
      if (tmp !== null) {
      ...
      src.startsWith("/browser/internal/fix-mode.html?url=") === true
    ) {
      let tmp = (src.split("?url=").pop() || "").split("&").shift() || null;
      if (tmp !== null) {
    ...
    if (this.window !== null) {
      ...
      if (title !== null) {
        window.document.title =
          "Tholian Stealth #" + tab.id + " - " + title.innerText.trim();
      }
    }
  } else {
    ...
    if (url.protocol === "stealth") {
      ...
      if (ENVIRONMENT.secure === true) {
        link =
          ...
          ":process.env.PORT/browser/internal/" +
          url.domain +
          ".html";
      } else {
        link =
      ...
      if (ENVIRONMENT.secure === true) {
        link =
          "https://" +
          ENVIRONMENT.hostname +
          ":process.env.PORT/browser/internal/fix-connection.html";
      } else {
        link =
          "http://" +
          ENVIRONMENT.hostname +
