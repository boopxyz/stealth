...
const SERVERS = [
  ...
  Object.assign(
    URL.parse("dnsh://dns.digitale-gesellschaft.ch:443/dns-query"),
    {
      hosts: [
        IP.parse("185.95.218.42"),
        IP.parse("2a05:fc84::42"),
  ...
  Object.assign(URL.parse("dnsh://doh.au.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("103.73.64.132"), IP.parse("2406:ef80:0100:0011::0011")],
  }),
  Object.assign(URL.parse("dnsh://doh.es.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("45.132.74.167"), IP.parse("2a0e:0dc0:0009:0017::0017")],
  }),
  Object.assign(URL.parse("dnsh://doh.it.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("45.91.95.12"), IP.parse("2a0e:0dc0:0008:0012::0012")],
  }),
  Object.assign(URL.parse("dnsh://doh.la.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("45.67.219.208"), IP.parse("2a04:bdc7:0100:0070::0070")],
  }),
  Object.assign(URL.parse("dnsh://doh.nl.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("5.2.75.75"), IP.parse("2a04:52c0:0101:0075::0075")],
  }),
  Object.assign(URL.parse("dnsh://doh.no.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("185.175.56.133"), IP.parse("2a0d:5600:0030:0028:0028")],
  }),
  Object.assign(URL.parse("dnsh://doh.ny.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("185.213.26.187"), IP.parse("2a0d:5600:0033:0003::0003")],
  }),
  Object.assign(URL.parse("dnsh://doh.pl.ahadns.net:443/dns-query"), {
    hosts: [IP.parse("45.132.75.16"), IP.parse("2a0e:0dc0:0007:000d::000d")],
  }),
  Object.assign(URL.parse("dnss://dot.libredns.gr:854"), {
    hosts: [IP.parse("116.202.176.26")],
  }),
  Object.assign(URL.parse("dnss://adfree.usableprivacy.net:853"), {
    hosts: [IP.parse("149.154.153.153")],
  }),
  ...
  Object.assign(URL.parse("dnsh://dns.quad9.net:5053/dns-query"), {
    hosts: [IP.parse("9.9.9.9"), IP.parse("2620:00fe::00fe")],
  }),
  Object.assign(URL.parse("dnsh://dns.rubyfish.cn:443/dns-query"), {
    hosts: [IP.parse("118.89.110.78"), IP.parse("47.96.179.163")],
  }),
...
const resolve = function (url, domain, type, callback) {
  ...
  if (internet.connection === "mobile" || internet.connection === "broadband") {
...
Router.prototype = {
  ...
  connect: function () {
    ...
    if (has_ipv4 === true) {
      ...
      if (connection === null) {
        connection = DNS.upgrade(
          null,
          URL.parse("dns://127.0.0.1:process.env.PORT")
        );

        connection.once("@connect", () => {
          console.info(
            "Router: UDP Service for dns://127.0.0.1:process.env.PORT started."
          );
        });

        connection.once("disconnect", () => {
          console.warn(
            "Router: UDP Service for dns://127.0.0.1:process.env.PORT stopped."
          );
        });
    ...
    if (has_ipv6 === true) {
      ...
      if (connection === null) {
        connection = DNS.upgrade(
          null,
          URL.parse("dns://[::1]:process.env.PORT")
        );

        connection.once("@connect", () => {
          console.info(
            "Router: UDP Service for dns://[::1]:process.env.PORT started."
          );
        });

        connection.once("disconnect", () => {
          console.warn(
            "Router: UDP Service for dns://[::1]:process.env.PORT stopped."
          );
        });
  ...
  resolve: function (query, callback) {
    ...
    if (
      ...
      let supports_v4 =
        ENVIRONMENT.ips.filter((ip) => ip.type === "v4").length > 0;
      let supports_v6 =
        ENVIRONMENT.ips.filter((ip) => ip.type === "v6").length > 0;
      ...
      resolve.call(this, Object.clone({}, url), domain, "A", (response_v4) => {
        resolve.call(
          ...
          (response_v6) => {
            ...
            if (response_v4 !== null) {
              response_v4.payload.questions.forEach((q) =>
                response.payload.questions.push(q)
              );
              response_v4.payload.answers.forEach((a) =>
                response.payload.answers.push(a)
              );
            }

            if (response_v6 !== null) {
              response_v6.payload.questions.forEach((q) =>
                response.payload.questions.push(q)
              );
              response_v6.payload.answers.forEach((a) =>
                response.payload.answers.push(a)
              );
            }
