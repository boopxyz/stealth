...
describe("Services.prototype.upgrade()/success", function (assert) {
  ...
  let url = URL.parse("ws://localhost:process.env.PORT");
...
describe("Services.prototype.upgrade()/failure", function (assert) {
  ...
  setTimeout(() => {
    let connection1 = WS.connect(URL.parse("ws://localhost:process.env.PORT"));
    let response1 = false;
  ...
  setTimeout(() => {
    let connection2 = WS.connect(URL.parse("ws://localhost:process.env.PORT"));
    let response2 = false;
  ...
  setTimeout(() => {
    let connection3 = WS.connect(URL.parse("ws://localhost:process.env.PORT"));
    let response3 = false;
