...
describe("SOCKS.decode()/connect/request", function (assert) {
  ...
  let packet3 = {
    ...
    payload: URL.parse(
      "[2606:2800:0220:0001:0248:1893:25c8:1946]:process.env.PORT"
    ),
  };
...
describe("SOCKS.decode()/status/error", function (assert) {
  ...
  let error6 = Buffer.from([
    0x05, 0x06, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  ]);
  let packet6 = {
    headers: {
      "@status": 0x06,
