...
import {
  connect as connect_stealth,
  disconnect as disconnect_stealth,
} from "../Stealth.mjs";
...
describe("SOCKS.connect()", function (assert) {
  ...
  let url = Object.assign(URL.parse("https://example.com/index.html"), {
    hosts: [
      IP.parse("93.184.216.34"),
      IP.parse("2606:2800:0220:0001:0248:1893:25c8:1946"),
    ],
    proxy: { host: "127.0.0.1", port: process.env.PORT },
  });
...
describe("SOCKS.send()/dnsh", function (assert) {
  ...
  let url = Object.assign(URL.parse("dnsh://cloudflare-dns.com/dns-query"), {
    hosts: [
      IP.parse("1.1.1.1"),
...
describe("SOCKS.send()/dnss", function (assert) {
  ...
  let url = Object.assign(URL.parse("dnss://cloudflare-dns.com"), {
    hosts: [
      IP.parse("1.1.1.1"),
      IP.parse("2606:4700:4700::1111"),
      IP.parse("1.0.0.1"),
...
describe("SOCKS.send()/http", function (assert) {
  ...
  let url = Object.assign(URL.parse("http://example.com/index.html"), {
    hosts: [
      IP.parse("93.184.216.34"),
      IP.parse("2606:2800:0220:0001:0248:1893:25c8:1946"),
    ],
  ...
  connection.once("response", (response) => {
    ...
    assert(
      response.payload
        .toString("utf8")
        .includes("<title>Example Domain</title>")
    );
...
describe("SOCKS.send()/ws", function (assert) {
  ...
  let url = Object.assign(URL.parse("ws://127.0.0.1:process.env.PORT"), {
    proxy: { host: "127.0.0.2", port: process.env.PORT },
  });
  let connection = SOCKS.connect(url);
...
describe("SOCKS.upgrade()", function (assert) {
  ...
  let url = Object.assign(URL.parse("https://example.com/index.html"), {
    ...
    proxy: { host: "127.0.0.1", port: 13337 },
  });
  let connection = SOCKS.connect(url);
...
export default finish("stealth/connection/SOCKS", {
  internet: true,
  network: true,
  ports: [80, 443, 853, process.env.PORT],
});
