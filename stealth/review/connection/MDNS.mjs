...
const PAYLOADS = {
  "DNS-SD": {
    REQUEST: Buffer.from([
      ...
      0x08, 0x5f, 0x73, 0x74, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x04, 0x5f, 0x77,
      0x73, 0x73, 0x07, 0x74, 0x68, 0x6f, 0x6c, 0x69, 0x61, 0x6e, 0x05, 0x6c,
      0x6f, 0x63, 0x61, 0x6c, 0x00, 0x00, 0x0c, 0x00, 0x01,

      // question: PTR for _stealth._ws.tholian.local
      0x08, 0x5f, 0x73, 0x74, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x03, 0x5f, 0x77,
      0x73, 0x07, 0x74, 0x68, 0x6f, 0x6c, 0x69, 0x61, 0x6e, 0x05, 0x6c, 0x6f,
    ...
    RESPONSE: Buffer.from([
      ...
      0xc0, 0x2d, 0x00, 0x0c, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x07,
      0x05, 0x74, 0x69, 0x6e, 0x6b, 0x79, 0x00,

      // answer: SRV for _stealth._ws.tholian.local with tinky:process.env.PORT
      0xc0, 0x2d, 0x00, 0x21, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d,
      0x00, 0x00, 0x00, 0x00, 0xff, 0x98, 0x05, 0x74, 0x69, 0x6e, 0x6b, 0x79,
      0x00,

      // answer: TXT for tinky with version=X0:2021-08-18
      0x05, 0x74, 0x69, 0x6e, 0x6b, 0x79, 0x00, 0x00, 0x10, 0x00, 0x01, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x16, 0x15, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f,
      0x6e, 0x3d, 0x58, 0x30, 0x3a, 0x32, 0x30, 0x32, 0x31, 0x2d, 0x30, 0x38,
      0x2d, 0x31, 0x38,

      // answer: A for tinky with 192.168.0.12
      0x05, 0x74, 0x69, 0x6e, 0x6b, 0x79, 0x00, 0x00, 0x01, 0x00, 0x01, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x04, 0xc0, 0xa8, 0x00, 0x0c,

      // answer: AAAA for tinky with 2a02:8071:0b99:aa00::4209
      0x05, 0x74, 0x69, 0x6e, 0x6b, 0x79, 0x00, 0x00, 0x1c, 0x00, 0x01, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x10, 0x2a, 0x02, 0x80, 0x71, 0x0b, 0x99, 0xaa,
      0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x42, 0x09,

      // answer: AAAA for tinky with 2a02:8071:0b99:aa00:b002:736e:e131:7202
      0x05, 0x74, 0x69, 0x6e, 0x6b, 0x79, 0x00, 0x00, 0x1c, 0x00, 0x01, 0x00,
      0x00, 0x00, 0x00, 0x00, 0x10, 0x2a, 0x02, 0x80, 0x71, 0x0b, 0x99, 0xaa,
      0x00, 0xb0, 0x02, 0x73, 0x6e, 0xe1, 0x31, 0x72, 0x02,
    ]),
  },
};
        ...
        payload: {
          ...
          answers: [
            ...
            },
            {
              domain: "tinky",
              type: "TXT",
              value: [Buffer.from("version=X0:2021-08-18", "utf8")],
            },
            {
        ...
        payload: {
          ...
          answers: [
            ...
            },
            {
              domain: "covert.local",
              type: "TXT",
              value: [Buffer.from("version=X0:1337", "utf8")],
            },
            {
              domain: "_stealth._ws.tholian.local",
              type: "SRV",
